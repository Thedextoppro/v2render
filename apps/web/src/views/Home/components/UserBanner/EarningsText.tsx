...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and DEX pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and DEX pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from DEX pool', data)
  }
