...
export interface NftMarketInterface extends utils.Interface {
  functions: {
    ...
    "buyTokenUsingWCLD(address,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "WCLD", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "buyTokenUsingWCLD",
  ...
  decodeFunctionResult(functionFragment: "WCLD", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "addCollection",
    data: BytesLike
  ): Result;
...
export interface NftMarket extends BaseContract {
  ...
  functions: {
    ...
    WCLD(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    WCLD(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    WCLD(overrides?: CallOverrides): Promise<PopulatedTransaction>;
